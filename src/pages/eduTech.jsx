                ...
                <div className="mt-10">
                  ...
                  <div className="flex flex-col md:flex-row gap-6 items-center">
                    ...
                    <p className="mt-4 text-base">
                      Adaptive Curriculum believes that math and science
                      education can be transformed so that every student can
                      excel, contribute to our society, and help improve our
                      nation's competitiveness in the global economy.
                    </p>
                  </div>
                  <p className="mt-4 text-base">
                    Our mission is to inspire students with active online
                    learning, engage them in concept mastery, and motivate them
                    to succeed in math and science.
                  </p>
                  <p className="mt-4 text-base">
                    With Adaptive Curriculum, you can enhance your Middle or
                    High School curriculum with interactive, 100% online
                    instruction that answers the question for your students:
