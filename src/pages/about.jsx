      ...
      >
        <Wrapper>
          <div className="pt-40 flex flex-col items-center">
            <div className="bg-white px-8 py-10 lg:py-1 rounded-3xl shadow-lg flex flex-col md:flex-row items-center gap-10  mb-12">
              <div className="flex-1">
                <h1 className="text-4xl md:text-5xl font-bold text-[#e63f38] mb-6">
                  {getText("hakkimizdaHeader")}
                </h1>
                <p className="text-gray-700 text-lg leading-relaxed">
                  EduAgency olarak, Türkiye ve Özbekistan arasında eğitim
                  alanında köprü görevi üstlenen, yenilikçi ve çözüm odaklı bir
                  entegratör firmasıyız. Eğitim sistemlerinin geliştirilmesi ve
                  uluslararası standartlarda hizmet sağlanması amacıyla okul
                  kurulumundan öğretmen eğitimlerine kadar geniş kapsamlı
                  çözümler sunuyoruz.
                </p>
              </div>
              <div className="flex-1">
