export const tr = {
  ...
  hero1: "Hoşgeldiniz",
  hero2:
    "İhtiyaçlarınıza göre uyarlanmış olağanüstü eğitim hizmetleri sunan güvenilir ortağınız.",
  ...
  tTrain2:
    "Öğretmenlerin gelişimine yönelik özel olarak hazırlanmış eğitim programlarımız.",
  ...
  akademikTur2:
    "Türkiye’nin en önemli bilim merkezlerinden biri olan Uzay Kampı’na yapılacak bu gezi, katılımcılara uzay bilimi ve teknolojisiyle ilgili uygulamalı öğrenim fırsatı sunuyor.",
  akademikTur3: "TÜRKİYEYE BİLİM VE KEŞİF TURU",
  akademikTur4:
    "STEM, robotik ve oyunlaştırma gibi modern eğitim yöntemlerini keşfetmek isteyen eğitimciler için Türkiye’deki üniversiteler, özel ve devlet okulları ziyaret edilecek.",
  akademikTur5: "TÜRKİYE EĞİTİM VE OKUL YÖNETİMİ KEŞİF TURU",
  akademikTur6:
    "Eğitim sistemlerine ve okul yönetim modüllerine dair yenilikçi çözümleri görmek isteyen lider öğretmenler için eşsiz bir deneyim sunuyor.",
  ...
  hizmetText7:
    "Yeni okul projelerinde kurulum aşamasından itibaren planlama, yapılandırma ve uygulama süreçlerinde stratejik destek sağlıyoruz. Okul konseptini oluşturma, iç tasarım ve donatım süreçlerinden yönetim sistemleri entegrasyonuna kadar tüm aşamalarda danışmanlık hizmeti veriyoruz.",
  hizmetText8:
    "Yerel ve uluslararası ihtiyaçlara uygun olarak okul öncesi, ilkokul, ortaokul ve lise seviyelerine özel müfredat ve eğitim modeli tasarlıyoruz. Projelerde çağdaş pedagojik yaklaşımları yerel değerlerle harmanlayarak uzun vadeli çözümler sunuyoruz.",
  hizmetText9:
    "Eğitimciler için kapsamlı öğretmen gelişim programları düzenleyerek modern öğretim teknikleri, liderlik becerileri ve sınıf yönetimi konularında yetkinliklerini artırıyoruz. Ayrıca, yönetici ve lider kadrolar için profesyonel rehberlik sunuyoruz.",
  hizmetText10:
    "Eğitimde dijital dönüşümü destekleyen teknolojik altyapıların kurulumu ve kullanımı konusunda danışmanlık hizmeti veriyoruz. Akıllı tahtalardan uzaktan eğitim platformlarına kadar yenilikçi çözümleri hayata geçiriyoruz.",
  hizmetText11:
    "Hem ulusal hem de uluslararası eğitim standartlarına uygun, öğrenci merkezli müfredat ve programlar geliştiriyoruz. STEM, sanat, dil eğitimi ve diğer branşlarda ihtiyaçlara özel çözümler sağlıyoruz.",
  hizmetText12:
    "Kurumların akademik performansını artırmak amacıyla detaylı değerlendirme ve ölçümleme süreçleri yönetiyoruz. Güçlü ve gelişmesi gereken yönleri tespit ederek sürdürülebilir gelişim planları sunuyoruz.",
