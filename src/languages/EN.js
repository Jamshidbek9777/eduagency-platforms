export const en = {
  ...
  akademikTur1: "Academic Tours",
  akademikTur2: "Inspire your career with educational and discovery tours shaping the future.",
  akademikTur3: "Space Camp Journey",
  akademikTur4: "At the Space Camp, you will find many activities and discoveries about science and technology. A fascinating experience for students!",
  akademikTur5: "Science and Discovery Tour to Turkey: A Unique Opportunity for Teachers Shaping the Future!",
  akademikTur6: "Dear educators from Uzbekistan! Teaching is not just a profession but an art of building the future. To take this art to the next level and be equipped with effective international methods, we invite you to an inspiring exploration of Turkey's leading science, education, and technology centers!",
  akademikTur7: "Educational and School Management Systems Exploration Tour in Turkey: A Unique Opportunity for Teachers Leading the Future!",
  akademikTur8: "Dear educators from Uzbekistan who aspire to lead the education sector, we invite you on an exciting journey to Turkey's world of education! With this discovery tour, you will explore educational systems, school management modules, scientific centers, and innovative projects, unveiling the significant impact you can make in education.",
